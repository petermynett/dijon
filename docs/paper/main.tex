...
\begin{itemize}
    ...
    \item \textbf{Silver}: A larger set (50--100 songs) where recordings are associated with known lead sheets, and have a high volume of material available on youtube. Although temporally unaligned, these provide harmonic and formal priors at scale, enabling broader comparative analysis.
    \item \textbf{Bronze}: Unlabeled recordings collected using the custom yt-dlp wrapper. These enable large-scale exploratory visualization once representations have been refined using Gold and Silver tiers.
